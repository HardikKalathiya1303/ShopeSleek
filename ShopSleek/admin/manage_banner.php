...
<div class="content pb-0">
            <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header form-control_heading"><strong>Banner</strong><small> Form</small></div>
                        <form method="post" enctype="multipart/form-data">
							<div class="card-body card-block">
							   <div class="form-group">
									<label for="heading1" class=" form-control-label">First Heading</label>
									<input type="text" name="heading1" placeholder="Enter First heading*" class="form-control" autocomplete="off" required value="<?php echo $heading1?>">
								</div>
								<div class="form-group">
									<label for="heading1" class=" form-control-label">Main Heading</label>
									<input type="text" name="heading2" placeholder="Enter Main Heading*" class="form-control" autocomplete="off" required value="<?php echo $heading2?>">
								</div>
								<div class="form-group">
									<label for="heading1" class=" form-control-label">Button Text</label>
									<input type="text" name="btn_txt" placeholder="Enter btn txt" class="form-control"  value="<?php echo $btn_txt?>">
								</div>
								<div class="form-group">
									<label for="heading1" class=" form-control-label">Link</label>
									<input type="text" name="btn_link" placeholder="Enter btn link" class="form-control" autocomplete="off" value="<?php echo $btn_link?>">
								</div>
								<div class="form-group">
									<label for="heading1" class=" form-control-label">Banner Image</label>
								...
								<div class="form-group">
									...
									<input type="number" name="order_no" placeholder="Enter order no" class="form-control" va value="<?php echo $order_no?>">
								</div>
