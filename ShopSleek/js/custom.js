...
function user_register(){
	...
	if(password.length<6){
		jQuery('#password_error').html('Please enter Minimum 6 characters password');
		is_error='yes';
	}
	if(password.length>30){
		jQuery('#password_error').html('Please enter Maximum 30 characters password');
		is_error='yes';
	}
	if(is_error==''){
		jQuery.ajax({
...
function forgot_password(){
	...
	if(password!=confirm_new_password){
		jQuery('#password_error').html('password and confirm password not match');
		is_error='yes';
	}
	if(password.length<6){
		jQuery('#password_error').html('Please enter Minimum 6 characters password');
	...
	if(is_error=='yes'){	
		jQuery('#mobile_error_f').html('wrong');
	}
	else{		
		jQuery.ajax({
